...
This is what I use to add `srt` subtitle files to directories full of video files. It uses `ffmpeg` and OpenAI's Whisper and optionally uses hardware accleration with NVIDIA CUDA for both.
